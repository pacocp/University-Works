...
#      badConsequence5 = BadConsequence.newLevelNumberOfTreasures('Toses los pulmones y pierdes 2 niveles',2,1,1)
...
#      badConsequence7 = BadConsequence.newLevelSpecificTreasures('Pierdes la armadura visible',0,[TreasureKind::ARMOR],nil)
