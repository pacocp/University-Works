...
(:task transport-person
  ...
  (:method Case1 ; si la persona est� en la ciudad no se hace nada
   ...
   (:method Case3 ;si no est� en la ciudad destino, y avion y persona no est�n en la misma ciudad
	  :precondition (and (at ?p - person ?c1 - city)
...
(:task mover-avion
 ...
 (:method no-suficiente-fuel-lento ;; este método se escogerá para usar la acción fly siempre que el avión no
                          ;;tenga fuel para volar desde ?c1 a ?c2
        ;; si no hay fuel suficiente el método se aplicará y repondrá fuel para poder volar
