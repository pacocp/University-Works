...
/* MUÑECO CON SOMBRERO */
	...
	glColor3f(0.0,0.0,0.0); // borde de oreja 1
	glPolygonMode(GL_FRONT_AND_BACK, GL_LINE);
	glLineWidth(2);
	glBegin (GL_POLYGON);
			glVertex3f(-4,3,0.5);
	...
	glColor3f(0.0,0.0,0.0); // borde de oreja 2
	glPolygonMode(GL_FRONT_AND_BACK, GL_LINE);
	glLineWidth(2);
	glBegin (GL_POLYGON);
			glVertex3f( 3,3,0.5);
	...
	Circle(0.9,1.5,5,20,GL_FILL);  //DIBUJAR UN OJO
	Circle(0.9,-1.5,5,20,GL_FILL); //Dibujar otro ojo

	glColor3f(1.0,0.0,0.0); //NARIZ
	glPolygonMode(GL_FRONT_AND_BACK, GL_FILL);
	glBegin(GL_TRIANGLES);
			glVertex3f(0.0,4.5,0.5);
			glVertex3f(-1,3.5,0.5);
			glVertex3f(1,3.5,0.5);
	glEnd();

	glColor3f(1.0,0.6,0.0); //BOCA
	glPolygonMode(GL_FRONT_AND_BACK, GL_FILL);
	glBegin(GL_POLYGON);
			glVertex3f(-2,1.3,0.5);
			glVertex3f(2,1.3,0.5);
			glVertex3f(2,2.1,0.5);
			glVertex3f(-2,2.1,0.5);
	glEnd();
